...
exports.run = async (client, message, args) => {
    ...
    .setDescription(`Toplam etkinliğinizi burada görebilir ve bu sunucudaki etkinlik ve liste hakkındaki bilgileri aşağıda bulabilirsiniz.`)
    .addField("Ses | Sıralama", `** **\n${voiceList}`)
    .addField("Mesaj | Sıralama", `** **\n${messageList}`);
